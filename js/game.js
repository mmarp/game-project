...
//1.Luis
const luis = new Character('luis', 1, ['./Images/luis.jpg', './Images/luis_out.jpg','./Images/pick/pick1.jpg', './Images/final_pick/luis-yes.jpg', './Images/final_pick/luis-no.jpg'], 'male', 'straight', 'black', true, 'brown', false);
...
//5.Joao F.
const joaoF = new Character('joaoF', 5,['./Images/joaoF.jpg', './Images/joaoF_out.jpg', './Images/pick/pick5.jpg', './Images/final_pick/joaoF-yes.jpg', './Images/final_pick/joaoF-no.jpg'], 'male', 'straight', 'brown', false, 'brown', true);
const joaoFPos = new Positioning(270, 245, 150, 150, joaoF);
joaoFPos.draw(0);

//6.Tiago P.
const tiagoP = new Character('tiagoP', 6,['./Images/tiagoP.jpg', './Images/tiagoP_out.jpg', './Images/pick/pick6.jpg', './Images/final_pick/tiagoP-yes.jpg', './Images/final_pick/tiagoP-no.jpg'], 'male', 'straight', 'brown', true, 'green', false);
...
//8.Joao B.
const joaoB = new Character('joaoB', 8,['./Images/joaoB.jpg', './Images/joaoB_out.jpg', './Images/pick/pick8.jpg', './Images/final_pick/joaoB-yes.jpg', './Images/final_pick/joaoB-no.jpg'], 'male', 'straight', 'brown', true, 'brown', false);
...
//10.Tiago S.
const tiagoS = new Character('tiagoS', 10,['./Images/tiagoS.jpg', './Images/tiagoS_out.jpg', './Images/pick/pick10.jpg', './Images/final_pick/tiagoS-yes.jpg', './Images/final_pick/tiagoS-no.jpg'], 'male', 'straight', 'brown', true, 'brown', true);
