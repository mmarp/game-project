...
//1.Luis
const luis = new Character('luis', './Images/c_margarida.jpg', 'male', 'straight', 'brown', true, 'brown', false, false);
const luisPos = new Positioning(270, 75, 150, 150, luis);
luisPos.draw();

//2.Stefano
const stefano = new Character('stefano','./Images/c_margarida.jpg', 'male', 'wavy', 'brown', true, 'blue', false, false);
...
//5.Joao F.
const joaoF = new Character('joaoF','./Images/c_margarida.jpg', 'male', 'straight', 'black', true, 'brown', false, true);
const joaoFPos = new Positioning(270, 245, 150, 150, joaoF);
joaoFPos.draw();

//6.Tiago P.
const tiagoP = new Character('tiagoP','./Images/c_margarida.jpg', 'male', 'straight', 'brown', true, 'green', false, false);
const tiagoPPos = new Positioning(440, 245, 150, 150, tiagoP);
tiagoPPos.draw();

//7.Gigi
const gigi = new Character('gigi','./Images/c_margarida.jpg', 'female', 'straight', 'brown', true, 'brown', false, false);
const gigiPos = new Positioning(610, 245, 150, 150, gigi);
gigiPos.draw();

//8.Joao B.
const joaoB = new Character('joaoB','./Images/c_margarida.jpg', 'male', 'straight', 'brown', true, 'brown', false, false);
const joaoBPos = new Positioning(780, 245, 150, 150, joaoB);
joaoBPos.draw();

//9.Victor
const victor = new Character('victor','./Images/c_margarida.jpg', 'male', 'straight', 'black', false, 'brown', false, false);
const victorPos = new Positioning(270, 415, 150, 150, victor);
victorPos.draw();

//10.Tiago S.
const tiagoS = new Character('tiagoS','./Images/c_margarida.jpg', 'male', 'straight', 'brown', true, 'brown', false, false);
...
//15.Gabriel
const gabriel = new Character('gabriel','./Images/helder_out.jpg', 'male', 'straight', 'brown', true, 'brown', false, false);
const gabrielPos = new Positioning(610, 585, 150, 150, gabriel);
gabrielPos.draw();

//16.Miguel
const miguel = new Character('miguel','./Images/c_margarida.jpg', 'male', 'curly', 'brown', true, 'brown', false, false);
